...
interface HardLimits {
    companion object {
        ...
        // Upper bound kept at 10.0 for every age type. Upstream lowered it to 9.0 for all but
        // PREGNANT, but this fork already ships profiles that use a DIA above 9, so tightening
        // it here would push existing users out of limits.
        val LIMIT_DIA = mapOf(
