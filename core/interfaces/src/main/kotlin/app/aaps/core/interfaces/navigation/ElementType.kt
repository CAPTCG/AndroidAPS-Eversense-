...
enum class ElementType(
    ...
    // (not the activeCalibration/xDrip broadcast path CALIBRATION above uses), so it's likewise
    // local/master-only — a client has no BLE connection to the transmitter.
